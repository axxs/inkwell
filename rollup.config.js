...
// Replaces build-time constants (e.g. process.env.NODE_ENV) so browser-bundled
// libs like Motion/framer-motion don't reference the non-existent `process`.
...
export default defineConfig({
    ...
    output: {
        ...
        // ES output so the dynamic import()s in the motion layer become real, network-lazy
        // code-split chunks (gsap/lenis/motion load on demand, only when motion actually runs).
        // Valid because default.hbs loads built/index.js with type="module".
        format: 'es',
